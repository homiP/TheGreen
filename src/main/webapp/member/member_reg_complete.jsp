...
<body class="w3-white">
	...
	<div
		...
		<div data-aos="fade-up" style="padding-top: 18%; padding-bottom: 2%;">
			<h2
				style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 45px; margin-left: 130px;">
