	...
	<div class="w-75" id="t_reservation_check_con_box">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link fs-5  text-dark" href="#">객실 예약 조회</a>
		  ...
		  <li class="nav-item">
        <a class="nav-link fs-5 text-dark" href="dining_reservation_check_cancel_nomember.jsp">다이닝 예약 조회</a>
		  </li>
	  </ul>
	</div>
<!-- nav 끝 -->
...
<!-- 상단에 투숙예정 / 투숙완료 / 취소내역 페이지 연결 nav -->	
	<div  class="w-50" id="t_reservation_sel_box">
		<ul class="nav nav-tabs nav-fill">
		  <li class="nav-item">
		    <a class="nav-link fs-5 text-dark"href="room_reservation_check_plan_nomember.jsp">투숙 예정</a>
		  </li>
		  <li class="nav-item">
