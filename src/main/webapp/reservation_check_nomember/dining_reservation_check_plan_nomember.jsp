 ...
 <!-- 최상단에 객실예약 조회와 다이닝 예약 조회로 연결되는 nav -->
	<div class="w-75" id="t_reservation_check_con_box">
      ...
      <li class="nav-item">
		  ...
		  <li class="nav-item">
        <a class="nav-link fs-5  text-dark" href="room_reservation_check_plan_nomember.jsp">객실 예약 조회</a>
		  </li>
		  <li class="nav-item">
...
<!-- 상단에 식사예정 / 식사완료 / 취소내역 페이지 연결 nav -->	
	<div  class="w-50" id="t_reservation_sel_box">
		<ul class="nav nav-tabs nav-fill">
		  <li class="nav-item">
		    <a class="nav-link active fs-5" href="#">식사 예정</a>
		  </li>
		  <li class="nav-item">
