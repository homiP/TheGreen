	...
	<div class="w-75" id="t_reservation_check_con_box">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link fs-5  text-dark" href="#">객실 예약 조회</a>
		  ...
		  <li class="nav-item">
        <a class="nav-link fs-5 text-dark" href="dining_reservation_check_plan_member.jsp">다이닝 예약 조회</a>
		  </li>
	  </ul>
	</div>
<!-- nav 끝 -->
...
<!-- 상단에 투숙예정 / 투숙완료 / 취소내역 페이지 연결 nav -->	
	<div  class="w-50" id="t_reservation_sel_box">
		<ul class="nav nav-tabs nav-fill">
		  ...
		  <li class="nav-item">
		    <a class="nav-link fs-5 text-dark" href="room_reservation_check_done_member.jsp">투숙 완료</a>
		  </li>
		  <li class="nav-item">
	...
	<div class="card mb-3" style="max-width: 40vmax;" id="t_reservation_info_card">
	  <div class="row g-0">
	    ...
	    <div class="col-md-8">
          ...
          <p class="card-text fs-6"><small class="text-muted" >투숙 예정</small></p>
          <p class="card-text fs-5" >
            <span>2022-12-17 ~ 2022-12-18</span><br>
	  ...
	  <div class="row g-0">
        ...
        <h5 class="card-title fs-3">Hotel The Green / Normal</h5>
          <p class="card-text fs-6"><small class="text-muted" >투숙 예정</small></p>
          <p class="card-text fs-5" >
            <span>2022-12-21 ~ 2022-12-23</span><br>
            <span>객실 수 : 1개</span><br>
            <span>인원 : 2명</span><br>
          </p>
